...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.userParameter.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-parameters.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="tipologia">{{ trans('cruds.userParameter.fields.tipologia') }}</label>
                <input class="form-control {{ $errors->has('tipologia') ? 'is-invalid' : '' }}" type="text" name="tipologia" id="tipologia" value="{{ old('tipologia', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parametro') ? 'is-invalid' : '' }}" type="text" name="parametro" id="parametro" value="{{ old('parametro', '') }}">
