...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.dealerPoint.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.dealer-points.update", [$dealerPoint->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_dealer') ? 'is-invalid' : '' }}" name="id_dealer_id" id="id_dealer_id">
                    @foreach($id_dealers as $id => $id_dealer)
                        <option value="{{ $id }}" {{ (old('id_dealer_id') ? old('id_dealer_id') : $dealerPoint->id_dealer->id ?? '') == $id ? 'selected' : '' }}>{{ $id_dealer }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conto_contabilita') ? 'is-invalid' : '' }}" type="text" name="conto_contabilita" id="conto_contabilita" value="{{ old('conto_contabilita', $dealerPoint->conto_contabilita) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codice') ? 'is-invalid' : '' }}" type="text" name="codice" id="codice" value="{{ old('codice', $dealerPoint->codice) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('point') ? 'is-invalid' : '' }}" type="text" name="point" id="point" value="{{ old('point', $dealerPoint->point) }}" required>
                @if($errors->has('point'))
                    <div class="invalid-feedback">
                        {{ $errors->first('point') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('indirizzo') ? 'is-invalid' : '' }}" type="text" name="indirizzo" id="indirizzo" value="{{ old('indirizzo', $dealerPoint->indirizzo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cap') ? 'is-invalid' : '' }}" type="text" name="cap" id="cap" value="{{ old('cap', $dealerPoint->cap) }}">
                @if($errors->has('cap'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cap') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('citta') ? 'is-invalid' : '' }}" name="citta_id" id="citta_id">
                    @foreach($cittas as $id => $citta)
                        <option value="{{ $id }}" {{ (old('citta_id') ? old('citta_id') : $dealerPoint->citta->id ?? '') == $id ? 'selected' : '' }}>{{ $citta }}</option>
                    @endforeach
                </select>
                @if($errors->has('citta'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('provincia') ? 'is-invalid' : '' }}" name="provincia_id" id="provincia_id">
                    @foreach($provincias as $id => $provincia)
                        <option value="{{ $id }}" {{ (old('provincia_id') ? old('provincia_id') : $dealerPoint->provincia->id ?? '') == $id ? 'selected' : '' }}>{{ $provincia }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $dealerPoint->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $dealerPoint->telefono) }}">
