...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.soggettiFatturato.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.soggetti-fatturatos.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="anno">{{ trans('cruds.soggettiFatturato.fields.anno') }}</label>
                <input class="form-control {{ $errors->has('anno') ? 'is-invalid' : '' }}" type="number" name="anno" id="anno" value="{{ old('anno', '') }}" step="1">
                @if($errors->has('anno'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mese') ? 'is-invalid' : '' }}" type="number" name="mese" id="mese" value="{{ old('mese', '') }}" step="1">
                @if($errors->has('mese'))
                    <div class="invalid-feedback">
                        {{ $errors->first('mese') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefoni') ? 'is-invalid' : '' }}" type="number" name="telefoni" id="telefoni" value="{{ old('telefoni', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('card') ? 'is-invalid' : '' }}" type="number" name="card" id="card" value="{{ old('card', '') }}" step="0.01">
                @if($errors->has('card'))
                    <div class="invalid-feedback">
                        {{ $errors->first('card') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('servizi') ? 'is-invalid' : '' }}" type="number" name="servizi" id="servizi" value="{{ old('servizi', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('altro') ? 'is-invalid' : '' }}" type="number" name="altro" id="altro" value="{{ old('altro', '') }}" step="0.01">
                @if($errors->has('altro'))
                    <div class="invalid-feedback">
                        {{ $errors->first('altro') }}
                    </div>
