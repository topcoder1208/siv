    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.dealers.update", [$dealer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dealer') ? 'is-invalid' : '' }}" type="text" name="dealer" id="dealer" value="{{ old('dealer', $dealer->dealer) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('indirizzo') ? 'is-invalid' : '' }}" type="text" name="indirizzo" id="indirizzo" value="{{ old('indirizzo', $dealer->indirizzo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cap') ? 'is-invalid' : '' }}" type="text" name="cap" id="cap" value="{{ old('cap', $dealer->cap) }}">
                @if($errors->has('cap'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cap') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('citta') ? 'is-invalid' : '' }}" name="citta_id" id="citta_id">
                    @foreach($cittas as $id => $citta)
                        <option value="{{ $id }}" {{ (old('citta_id') ? old('citta_id') : $dealer->citta->id ?? '') == $id ? 'selected' : '' }}>{{ $citta }}</option>
                    @endforeach
                </select>
                @if($errors->has('citta'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('provincia') ? 'is-invalid' : '' }}" name="provincia_id" id="provincia_id">
                    @foreach($provincias as $id => $provincia)
                        <option value="{{ $id }}" {{ (old('provincia_id') ? old('provincia_id') : $dealer->provincia->id ?? '') == $id ? 'selected' : '' }}>{{ $provincia }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $dealer->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $dealer->telefono) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conto_contabilita') ? 'is-invalid' : '' }}" type="text" name="conto_contabilita" id="conto_contabilita" value="{{ old('conto_contabilita', $dealer->conto_contabilita) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codice') ? 'is-invalid' : '' }}" type="text" name="codice" id="codice" value="{{ old('codice', $dealer->codice) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stato') ? 'is-invalid' : '' }}" type="text" name="stato" id="stato" value="{{ old('stato', $dealer->stato) }}">
                @if($errors->has('stato'))
                    <div class="invalid-feedback">
                        {{ $errors->first('stato') }}
                    </div>
