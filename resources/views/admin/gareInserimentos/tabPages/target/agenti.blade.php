...
<div class="tab-pane fade" id="nav-target-agenti" role="tabpanel" aria-labelledby="nav-target-agenti-tab" url="{{ route('admin.gare-inserimento-dettaglis.insertFrom', ['gare_inserimento_id' => 0, 'tipologia_id' => 16]) }}" style="padding-left: 30px;">
            ...
            <div class="row">
                <div class="form-check col-3">
                    <div class="custom-file">
                        <div id="target-agenti-file" class="file-uploader" url="{{ route('admin.gare-inserimento-dettaglis.insertFromFileUpload', ['tipologia_id' => 16, 'gare_inserimento_id' => 0]) }}">Scegli il file di elenco</div>
                    </div>
                </div>
            </div>
        </p>
    ...
    <div class="row">
        <div id="target_dettaglis_agenti_lists_wrapper" class="target-table col-lg-4 col-md-6 col-sm-12">
            <table class="col-lg-4 col-md-6 col-sm-12" id="target_dettaglis_agenti_lists" style="width: 100%;" url="{{route('admin.gare-inserimento-dettaglis.getDettaglis', ['tipologia_id' => 16, 'gare_inserimento_id' => 0])}}">
                <thead>
                    <tr>
                        <th></th>
                        <th>Codice</th>
