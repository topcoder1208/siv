...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-beneficiariGareInserimentos">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.gareInserimento.fields.beneficiari') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($gareInserimentos as $key => $gareInserimento)
                        <tr data-entry-id="{{ $gareInserimento->id }}">
                            ...
                            <td>
                                @foreach($gareInserimento->beneficiaris as $key => $item)
                                    <span class="badge badge-info">{{ $item->soggetto }}</span>
                                @endforeach
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-beneficiariGareInserimentos:not(.ajaxTable)').DataTable({ buttons: dtButtons })
