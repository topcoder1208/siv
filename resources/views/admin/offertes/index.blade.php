...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Offerte">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" strict="true">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\Offerte::TIPOLOGIA_SELECT as $key => $item)
                        ...
                        <td>
                            <select class="search">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach($tecnologia as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-Offerte:not(.ajaxTable)').DataTable({ buttons: dtButtons })
